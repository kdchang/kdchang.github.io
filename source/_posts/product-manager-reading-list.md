...
產品經理在工作上需要跟許多跨部門和跨單位的團隊合作，必須具備溝通和解決問題的能力，是一個跨職能和跨領域的綜合性職務。因此，透過大量閱讀不同領域的書籍，將讓自己可以掌握更多產品經理（Product Manager, PM）所需具備的軟實力和硬實力。以下透過整理不同構面的產品經理推薦書單，讓我們可以點滿我們的技能樹。
